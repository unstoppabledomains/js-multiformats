...
### Important !
 This is forked version of multiformats to support using this library in node commonjs environment.  
  
 To generate CommonJS build run `npm run build` and cjs output will be placed in `dist/cjs` folder.  
