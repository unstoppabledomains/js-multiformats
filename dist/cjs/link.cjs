...
var from = ({ name, prefix, encode: encode3, decode: decode6 }) => new Codec(name, prefix, encode3, decode6);
...
var createLegacy = (digest) => CID.create(0, DAG_PB_CODE2, digest);
var create2 = (code, digest) => CID.create(1, code, digest);
var isLink = (value) => {
  if (value == null) {
    return false;
  }
...
var decode5 = (bytes) => CID.decode(bytes);
